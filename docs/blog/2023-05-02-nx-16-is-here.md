...
· [Rescoping From @nrwl/_ to @nx/_](#8e44)  
...
Nx has had support for developing Node-based backends for a while. It was a popular choice for building your BFF in a monorepo-based setup alongside your React or Angular application. [In Nx 15.7](/blog/nx-15-7-node-support-angular-lts-lockfile-pruning#de54) we decided to expand that support and really go deep into improving the overall DX.
